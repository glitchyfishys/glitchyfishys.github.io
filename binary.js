...
function Update(){
    ...
    Glitchy.innerHTML = wordCycle(["Steller", "Irreplaceable", "Eternal", "Uncontainable", "Near Perfect", "Fundamental", "Celestial", "Unbound", "Quintessence", "Catalyst"]) + " Glitchyfishys";
